...
if  __name__=='__main__':
    ...
    select_b_idx, select_h_idx, select_w_idx, valid_idx, valid_in_dis_idx, select_mask = fused_conv_select_k(xyz1, xyz2, idx_n2, random_hw, H, W, npoints, kernel_size_H, kernel_size_W, K, bool(flag_copy), float(distance), stride_h, stride_w, select_b_idx, select_h_idx, select_w_idx, valid_idx, valid_in_dis_idx, select_mask,SMALL_H,SMALL_W)
