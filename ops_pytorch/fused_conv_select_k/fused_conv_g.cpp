...
void torch_FusedConvSelectKLauncher(
    ...
    FusedConvSelectKLauncher(batch_size, H, W, npoints, kernel_size_H, kernel_size_W, K, flag_copy, distance, 
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("fused_conv_select_k",
          &torch_FusedConvSelectKLauncher,
          "torch_FusedConvSelectKLauncher kernel warpper");
}