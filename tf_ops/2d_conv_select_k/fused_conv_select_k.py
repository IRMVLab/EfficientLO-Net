...
def fused_conv_select_k(xyz1, xyz2, idx_n2, random_hw, H, W, npoints, kernel_size_H, kernel_size_W, K, flag_copy, distance, stride_h, stride_w):
    '''
    Input:
    ...
    '''
    return fused_conv_select_k_module.fused_conv_select_k(xyz1, xyz2, idx_n2, random_hw, H, W, npoints, kernel_size_H, kernel_size_W, K, flag_copy, distance, stride_h, stride_w)
...
if  __name__=='__main__':
    ...
    select_bhw_idx, valid_idx, valid_in_dis_idx, select_mask = fused_conv_select_k(xyz, xyz2, idx_n2, random_hw, H, W, npoints, kernel_size_H, kernel_size_W, K, flag_copy, distance, 1, 1)
